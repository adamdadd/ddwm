...
static const unsigned int gappx     = 8;        /* pixel gap around windows */
...
static const char *fonts[]          = { "Menlo:size=16", "fontawesome:size=18" };
static const char dmenufont[]       = "monospace:size=10";
static const char col_gray1[]       = "#222222";
static const char col_gray2[]       = "#444444";
static const char col_gray3[]       = "#bbbbbb";
static const char focus_font[]      = "#fbf1c7";
static const char col_focus[]       = "#928374";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { focus_font,col_focus, col_focus },
};
